(function()
{
    /* При объявлении функции возможно указать описание функции (пример ниже), которое
    ...
    @memberof insertArr
    @param {Array} arr - двумерный массив для вставки
    @param {ApiRange} oStartRange - левая верхняя ячейка таблицы
    @returns {ApiRange} */
    Api.myMacro.Utils.insertArr = function insertArr(arr, oStartRange)
